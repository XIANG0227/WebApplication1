<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signIn2.aspx.cs" Inherits="WebApplication1.signIn2" %>
...
<body>
  ...
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div>Site<span>SignIn</span></div>
		</div>
		<br>
		<div class="login">
				<input type="text" placeholder="username" id="user" name="user"><br>
				<input type="password" placeholder="password" id="passwd" name="password"><br>
				<input type="button" id="bt1"  value="Login">
		</div>
